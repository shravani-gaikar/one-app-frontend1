...
import TodaysAppointments from "../../Reporter/Pages/TodaysAppointments.jsx";
...
it("changes value when clicked", async() => {
  ...
  act(() => {
    render(<TodaysAppointments></TodaysAppointments>, { wrapper: Wrapper });
...
//   const userName = await screen.findByText("TODAY'S APPOINTMENTS");
