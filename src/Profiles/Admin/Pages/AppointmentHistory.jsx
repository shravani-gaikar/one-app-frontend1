...
import {history_appointment, table_heading, button_name} from '../Files/Appointment'
import { getAppointmentsHistory, deleteAppointmentHistoryAction } from '../../../Redux/Action/AdminAction/AdminAction'
...
function AppointmentHistory() {
  ...
  const data = useSelector(state => state.Admin.appointmentHistory);
  ...
  const deleteAppointment = (e) => {
    dispatch(deleteAppointmentHistoryAction(e.target.value))
    setShow(true);
  }
      ...
      return (
        <>
          <tr key={user._id}>
            ...
            <td>
              <button className="btn btn-danger  round-button btn-sm" value={user._id} onClick={deleteAppointment}>
  ...
  return (
    ...
    <h2 className="m-5 text-navy">{history_appointment.title}</h2>
      ...
      <ExportToExcel apiData={data} fileName="History Appointment" /> 
